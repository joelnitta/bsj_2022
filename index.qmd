...
また、シダ植物は被子植物と比べて全体の種数が少ないため、比較的に調べやすい研究対象です。被子植物の約35万種に対して、シダ植物は約1万２千種しか存在しておらず、そのうち約40から50パーセントはシーケンスデータが公開されているので、全体の系統樹を作るのに適した対象です。
:::
...
- そのうち、**ファイロゲノミクス**に切り替える

::: {.notes}
最後に、これからの予定と目的を説明させていただきたいと思います。
まずは、FTOLを完成させることです。現在のFTOLはシダ植物の半分弱を含めますが、残りの５０何パーセントを今後加えたいと考えています。こうするためには、ずっとGenBankにデータが上がるのを待っているだけでは時間がかかり過ぎますので、今後は自分で新しいシーケンスデータを作る必要があります。特に有効だと思っているのは、植物標本庫に収まっている標本からゲノムスキミングによって葉緑体DNAシーケンスを読む技術です。
