...
- 「最新」の系統樹を今日構築して発表しても、**明日には古くなってしまう**
...
そして、データだけではなく、方法も改善していく予定です。例えば、次のバージョンでは分岐年代推定の方法をtreePLからRelDateに変えようと考えています。後者の方が最近の論文によるとより正確ですから。
