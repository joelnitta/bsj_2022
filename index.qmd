...
- Use [World Ferns](https://www.worldplants.de/world-ferns/ferns-and-lycophytes-list) as basis for new, fern-specific taxonomic database, [pteridocat](https://github.com/fernphy/pteridocat)

- Resolve GenBank species names to pteridocat using [taxastand](https://github.com/joelnitta/taxastand)\* R package

::: aside
\*I am developer; if you have questions, please ask!
:::
